...
## Skills & Expertise
| Languages | Frameworks | Methods | Tools & Cloud |
| --------- | ---------- | ------- | ------------- |
| C# | Asp.Net Core | Test Driven Development | GitHub Actions || TypeScript | Asp.Net | CI/CD | Azure Devops || JavaScript | Blazor | Agile Methodologies | Octopus Deploy || HTML & CSS | React | Specification by Example | Azure |
