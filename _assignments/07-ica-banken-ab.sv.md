...
skills:
 ...
 - WMI
highlights:
 - Kvalitetsanalys av databasdesign.
 - Felsökning och optimering av SQL-skript för dataimport/export och databasunderhåll.
 - VBScript för SQL Server-inventering med WMI.
---
<!--more-->
## Kontext
